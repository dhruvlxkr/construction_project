  ...
  return (
    <>
      ...
      <main>
       ...
       <section className="section-8 bg-light py-4">
             ...
             <div className="col-md-3 col-lg-3 mb-3">
                 <div className="card shadow border-0">
                  <div className="card-img-top">
                   <img
                    src="../../images/pexels-sindre-fs-1040880.jpg"
                    alt=""
                    className="w-100"
                  />
                    ...
                    <div className="card-body p-4">
                     <div className="card-title pb-0 mb-0">John</div>
                     <div className="sub-title mb-3">Web Developer</div>
